...
export default function Team(){
  const cofounders = [
    {name: 'Co-founder 1', role: 'Co-founder', img: '/images/cofounder1.jpg'},
    {name: 'Co-founder 2', role: 'Co-founder', img: '/images/cofounder2.jpg'},
        ...
        <div className="md:col-span-1">
          ...
          <div className="mt-4 flex flex-col items-center text-center">
            <div className="w-44 h-44 rounded-full overflow-hidden bg-gray-100">
              <Image src="/images/funder.jpg" alt="Funder" width={176} height={176} className="object-cover" />
            </div>
